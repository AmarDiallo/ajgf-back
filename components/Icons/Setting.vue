<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
        ...
        <g fill="none" stroke="currentColor" stroke-width="2">
            ...
            <g opacity="0">
                <use href="#lineMdCog0"></use>
                <use href="#lineMdCog0" transform="rotate(60 12 12)"></use>
                <use href="#lineMdCog0" transform="rotate(120 12 12)"></use>
                <use href="#lineMdCog0" transform="rotate(180 12 12)"></use>
                <use href="#lineMdCog0" transform="rotate(240 12 12)"></use>
                <use href="#lineMdCog0" transform="rotate(300 12 12)"></use>
